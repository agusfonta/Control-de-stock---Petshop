...
- `frontend/src/api.js:1` — único cliente HTTP (Bearer, maneja 401/403) | `frontend/src/App.jsx:13` — tabs Productos/Ventas/Caja/Historial/Clientes/Categorías/Proveedores/Usuarios | `frontend/src/index.css` — un solo layout compu+tablet apaisada: tablas nuevas van en `.tbl-wrap`, táctil solo bajo `@media (pointer:coarse)`
